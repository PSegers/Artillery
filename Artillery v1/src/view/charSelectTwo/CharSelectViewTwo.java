 ...
 * @version 1.0 13/03/2016 20:29.
 */
public class CharSelectViewTwo extends GridPane{
    ...
    private void layoutNodes() {
        ...
        upperSmallRekt.setFill(Color.rgb(75,75,75));
        upperRekt.setFill(Color.TRANSPARENT);
        nameRekt.setFill(Color.TRANSPARENT);
        factionRekt.setFill(Color.TRANSPARENT);
        terrTypeRekt.setFill(Color.TRANSPARENT);
